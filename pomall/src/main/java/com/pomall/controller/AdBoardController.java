...
public class AdBoardController {
	...
	// 공지사항 저장
	@PostMapping("/insert")
	public String insert(AdBoardVO adboard) {
		
		adBoardService.insert(adboard);
	...
	public void get(@RequestParam("adbo_num") Long adbo_num, Model model) {
	...
	// 수정하기
	@PostMapping("/modify")
	public String modify(AdBoardVO adboard) {
		
		adBoardService.modify(adboard);
	...
	// 공지사항 삭제하기
	@GetMapping("/delete")
	public String delete(Long adbo_num) {
		
		adBoardService.delete(adbo_num);
	...
	public void user_board_list(Criteria cri, Model model) {
	...
	// 사용자 게시판 읽기
	@GetMapping("/user_board_get")
	public void user_board_get(@RequestParam("user_num") Long user_num, Model model) {
	...
	public String user_board_delete(Long user_num) {
		
		boardService.delete(user_num);
		
		return "redirect:/admin/board/user_board_list";
	}
}
