  ...
  <body>
        ...
        <div class="col-md-12">
          <div>
            ...
            <div class="row border-top pt-3">
              <!-- 위쪽 라인과 패딩 여백 5까지 쓸 수 있다. -->
              <div class="col-md-2">
                <label for="mb_name">이름</label>
              </div>
              <div class="col-md-10">${memberVO.mb_name }</div>
            </div>
            ...
            <h4 class="mb-3 mt-3">
              배송정보<span style="float: right; margin-right: 10px"
                ><input type="checkbox" id="same_info" /><small
                  >위 정보와 같음.</small
                ></span
              >
            </h4>
            ...
            <div class="row pt-3">
              ...
              <div class="col-md-8">
                ...
                <div style="display: flex; align-items: center">
                  <p id="pay_user_vw" style="display: none">
                    입금자명 :
                    <input
                      type="text"
                      name="pay_user"
            ...
            <div class="custom-control custom-checkbox">
              <input
                ...
                id="mb_receive"
              />
              <label class="custom-control-label" for="mb_receive"
            ...
            <div class="mb-4 text-center">
              ...
              <img
                src="/image/payment_icon_yellow_medium.png"
                data-paytype="kakaopay"
                name="btn_buy"
                id="kakao_pay"
              />
            </div>
            ...
            <tbody>
              ...
              <c:forEach items="${cart_list }" var="cartListDTO">
                <tr>
                  <td>
                    <img
                      src="/cart/displayImage?folderName=${cartListDTO.pro_up_folder }&fileName=s_${cartListDTO.pro_img}"
                    />
                    <c:out value="${cartListDTO.pro_name }"></c:out>
                  </td>
                  <td>${cartListDTO.ca_amount }</td>
                  <td>포인트 : 0</td>
                  <td>무료배송</td>
                  <td>
                    <fmt:formatNumber
    ...
    <script>
      $(document).ready(function () {
        ...
        // 위 정보와 같음 체크박스 체크시 이름, 연락처 정보 들어오게
        $("#same_info").on("click", function () {
          if ($(this).is(":checked")) {
            $("#ord_name").val("${memberVO.mb_name}");
            $("#ord_tel").val("${memberVO.mb_phone}");
          } else {
            $("#ord_name").val("");
            $("#ord_tel").val("");
          }
        ...
        // 입금 은행 선택시 주문자정보의 이름이 입금자명에 삽입
        $("#pay_bank").on("click", function () {
          let bankSelected = $(this).val();

          if (bankSelected) {
            $("#pay_user_vw").show();
            $("#pay_user").val("${memberVO.mb_name}");
          } else {
            $("#pay_user_vw").hide();
            $("#pay_user").val("");
          }
