            ...
            <form class="form-horizontal" method="post" action="/member/findID">
              <div class="box-body">
                <div class="form-group">
                  <label for="find_mb_id" class="col-sm-2 control-label">아이디</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="find_mb_id" id="find_mb_id" placeholder="아이디 입력하세요.">
                  </div>
                </div>
            ...
            success : function(result) {
              if(result == "success") {
                  ...
                  $.ajax({
                      url: '/member/findPW',
                      type: 'post',
                      data: {mb_id: $("#find_mb_id").val(), mb_email: $("#find_mb_email").val()},
                      dataType: 'text',
