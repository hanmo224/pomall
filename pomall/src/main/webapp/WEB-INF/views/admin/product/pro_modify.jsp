     		...
     		<div class="box box-primary">
     			...
     			<div class="box-body">	
					  <div class="form-group row">
					    <label for="pro_name" class="col-sm-2 col-form-label">카테고리</label>
					    <div class="col-sm-3">
                ...
                <input type="hidden" name="keyword" value="${cri.keyword}">
					    	<select name="cg_procode" id="firstCategory" class="form-control">
					    		...
					    		<c:forEach items="${categoryList }" var="category">
					    			<option value="${category.cg_code }" ${category.cg_code == categoryVO.cg_code ? 'selected': ''}>${category.cg_name }</option>
					    		</c:forEach>
					     	</select>
					    </div>
						<div class="col-sm-3">					    	
                  ...
                  <c:forEach items="${subCategoryList }" var="category">
					    			<option value="${category.cg_code }" ${category.cg_code ==  productVO.cg_code ? 'selected' : ''}>${category.cg_name }</option>
					    		</c:forEach>
					    	</select>
					  </div>
					  </div>
					  <div class="form-group row">
					    ...
					    <div class="col-sm-4">
                <input type="hidden" class="form-control" id="pro_code" name="pro_code" value="${productVO.pro_code}">
					  ...
					  <div class="form-group row">
					    <label for="pro_dis" class="col-sm-2 col-form-label">할인율</label>
					    <div class="col-sm-4">
					      <input type="text" class="form-control" id="pro_dis" name="pro_dis" value="${productVO.pro_dis}">
					    </div>
					  ...
					  <div class="form-group row">
					    <label for="pro_img" class="col-sm-2 col-form-label">상품이미지</label>
