                  ...
                  <div class="box-body">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-3">
                        ...
                        <select name="cg_procode" id="firstCategory" class="form-control" disabled>
                        ...
                        <input type="hidden" name="cg_procode" value="${categoryVO.cg_code}">
                      </div>
                      <div class="col-sm-3">                         
                        <select name="cg_code" id="secondCategory" class="form-control" disabled>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <img
                          id="curr_img"
                          src="/admin/product/displayImage?folderName=${productVO.pro_up_folder }&fileName=s_${productVO.pro_img}"
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <textarea
                          ...
                          readonly
                        >
${productVO.pro_content}</textarea
                        >
                      </div>
                    </div>
                    <div class="form-group row">
