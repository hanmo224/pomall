            ...
            <div class="box-header with-border">
                <div class="form-group row">
                  ...
                  <form id="searchForm" action="" method="get">
                    탈퇴일 : <input type="date" name="inactive_sDate" value="${inactive_sDate}"> ~ <input type="date" name="inactive_eDate" value="${inactive_eDate}">
                    <select name="type">
              ...
              <table class="table table-bordered">
                <tbody>
                  <tr>
                    ...
                    <th style="width: 4%">닉네임</th>
                    <th style="width: 8%">이메일 주소</th>
                    <th style="width: 8%">전화번호</th>
                    <th style="width: 8%">가입일</th>
                    <th style="width: 8%">탈퇴일</th>
                    <th style="width: 5%">수신동의</th>
                    <th style="width: 5%">회원상태</th>
                    <th style="width: 5%">관리</th>
                  </tr>
                  <c:forEach items="${member_inactive }" var="memberVO">
                  <tr>
                    ...
                    <td><fmt:formatDate value="${memberVO.inactive_date }" pattern="yyyy-MM-dd HH:mm"/></td>
...
<script id="memberDetailView" type="text/x-handlebars-template">
 ...
 {{#each .}}
   ...
   <td style="width: 10%">{{mb_gender}}</td>
   <td style="width: 10%">{{mb_point}}</td>
   <td style="width: 5%">{{mb_zipcode}}</td>
...
<script>
  $(document).ready(function() {
     ...
     $("#btn_order_search").on("click", function() {
      searchForm.attr("action", "/admin/member/member_inactive");
     ...
     $("ul.pagination a").on("click", function(e) {
      ...
      actionForm.attr("action", "/admin/member/member_inactive");
      actionForm.find("input[name='pageNum']").val($(this).attr("href"));

      actionForm.find("input[name='inactive_sDate']").remove();
      actionForm.find("input[name='inactive_eDate']").remove();

      actionForm.append("<input type='hidden' name='inactive_sDate' value='${inactive_sDate}'>");
      actionForm.append("<input type='hidden' name='inactive_eDate' value='${inactive_eDate}'>");
